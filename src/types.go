...
const (
	...
	CASTLING_WHITE = CASTLING_WHITE_OO | CASTLING_WHITE_OOO
	CASTLING_BLACK = CASTLING_BLACK_OO | CASTLING_BLACK_OOO
	CASTLING_ALL   = CASTLING_WHITE | CASTLING_BLACK
	NR_CASTLING    = CASTLING_ALL + 1
)
